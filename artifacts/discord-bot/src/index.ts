...
// There is exactly one messageCreate registration path. Prefixless commands are
// handled inside that same path, preventing owners from being processed twice.
...
loginPromise.then(() => clearTimeout(timeout)).catch(err => {
