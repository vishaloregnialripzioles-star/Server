...
export interface LevelUpConfig { title?: string; description?: string; imageUrl?: string; color?: number; channelId?: string; }
...
export interface TicketPanelConfig { id: string; name: string; title: string; description: string; color?: number; categoryId?: string; supportRoleId?: string; questions: string[]; }
...
export interface RecoveryChannel { id: string; name: string; type: number; position: number; parentId?: string; topic?: string; nsfw?: boolean; rateLimitPerUser?: number; bitrate?: number; userLimit?: number; rtcRegion?: string; videoQualityMode?: number; defaultAutoArchiveDuration?: number; defaultThreadRateLimitPerUser?: number; defaultForumLayout?: number; defaultSortOrder?: number; permissionOverwrites: RecoveryOverwrite[]; }
