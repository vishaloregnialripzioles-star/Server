...
export interface RecoveryRole { id: string; name: string; color: number; hoist: boolean; permissions: string; position: number; }
...
export interface RecoveryBackup { id: string; guild: RecoveryGuildSettings; roles: RecoveryRole[]; channels: RecoveryChannel[]; emojis: RecoveryEmoji[]; }
