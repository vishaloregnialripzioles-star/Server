...
export interface Config { logChannel?: string; inviteLogChannel?: string; muteRole?: string; jailRole?: string; chatBanRole?: string; ticketCategory?: string; ticketSupportRole?: string; ticketPanels?: Record<string, TicketPanelConfig>; starboardChannel?: string; starboardThreshold: number; levelChannel?: string; leveling?: LevelingConfig; snipeEnabled: boolean; prefix?: string; levelRoles?: Record<string, string>; inviteRoles?: Record<string, string>; levelUpMessage?: { title?: string; description?: string; imageUrl?: string; }; automod?: AutoModConfig; moderationTemplates?: ModerationTemplate[]; logging?: LoggingConfig; giveawayDaily?: GiveawayDailyConfig; joinRole?: JoinRoleConfig; socialNotifications?: SocialNotificationConfig; reactionRoles?: ReactionRoleConfig; roleConnections?: RoleConnectionConfig; aiPersonality?: 'funny' | 'roaster' | 'chill' | 'nerd' | 'savage'; aiChannelId?: string; bloxValueChannelId?: string; bloxScannerChannelId?: string; bloxScannerScreenshots?: Record<string, BloxScannerScreenshot>; bloxValueEmojis?: Record<string, string>; }
