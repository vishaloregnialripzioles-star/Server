...
V('East Dragon',['east dragon','dragon east'],'Mythical','Beast','2.46B','6.57B','15M','6/10','Stable','PVP, Trading'),
...
V('T-Rex',['t-rex','trex'],'Mythical','Beast','20M','3.33B','2.7M','8/10','Stable','PVP, Grinding'),
V('Gravity',['gravity'],'Mythical','Natural','10M','3.21B','2.5M','5/10','Stable','PVP'),
V('Mammoth',['mammoth'],'Mythical','Beast','10M','3.33B','2.7M','5/10','Stable','PVP, Grinding'),
V('Spirit',['spirit'],'Mythical','Natural','10M','3.81B','3.4M','7/10','Stable','PVP'),
V('Shadow',['shadow'],'Mythical','Natural','6.5M','3.51B','2.9M','5/10','Stable','PVP'),
V('Lightning',['lightning','rumble'],'Legendary','Logia','40M','2.85B','2.1M','6/10','Stable','PVP'),
V('Pain',['pain'],'Legendary','Natural','10M','2.97B','2.3M','5/10','Stable','PVP'),
V('Portal',['portal'],'Legendary','Natural','10M','2.49B','1.9M','10/10','Overpaid','Mobility, PVP'),
V('Buddha',['buddha','human buddha'],'Legendary','Beast','10M','1.71B','1.2M','10/10','Overpaid','PVP, Grinding'),
V('Blizzard',['blizzard'],'Legendary','Logia','5M','3.09B','2.4M','5/10','Stable','PVP, Grinding'),
V('Phoenix',['phoenix'],'Legendary','Beast','2.75M','2.49B','1.8M','3/10','Stable','PVP'),
V('Creation',['creation'],'Legendary','Natural','2.5M','1.89B','1.4M','2/10','Stable','N/A'),
V('Sound',['sound'],'Legendary','Natural','2.5M','2.25B','1.7M','4/10','Stable','PVP'),
V('Spider',['spider'],'Legendary','Natural','1.5M','2.01B','1.5M','2/10','Stable','PVP'),
V('Love',['love'],'Legendary','Natural','1.5M','1.77B','1.3M','3/10','Stable','PVP'),
V('Quake',['quake'],'Legendary','Natural','1M','1.44B','1M','2/10','Stable','PVP'),
V('Magma',['magma'],'Rare','Logia','1.15M','1.17B','960K','5/10','Overpaid','Grinding, PVP'),
V('Light',['light'],'Rare','Logia','800K','930M','650K','2/10','Stable','Mobility, PVP, Grinding'),
V('Ghost',['ghost'],'Rare','Natural','800K','1.08B','940K','1/10','Underpaid','PVP'),
V('Rubber',['rubber'],'Rare','Natural','700K','990M','750K','1/10','Stable','PVP'),
V('Diamond',['diamond'],'Uncommon','Natural','1M','750M','600K','2/10','Stable','Grinding'),
V('Eagle',['eagle','falcon'],'Uncommon','Beast','800K','735M','550K','2/10','Stable','Grinding'),
V('Ice',['ice'],'Uncommon','Logia','550K','600M','350K','2/10','Stable','PVP, Grinding'),
V('Sand',['sand'],'Uncommon','Logia','420K','660M','420K','1/10','Stable','Grinding'),
V('Dark',['dark'],'Uncommon','Logia','400K','720M','500K','1/10','Stable','PVP'),
V('Flame',['flame'],'Uncommon','Logia','250K','450M','250K','1/10','Stable','Grinding'),
V('Spike',['spike'],'Common','Natural','180K','140M','180K','1/10','Stable','Grinding'),
V('Smoke',['smoke'],'Common','Logia','100K','120M','100K','1/10','Stable','Grinding'),
V('Bomb',['bomb'],'Common','Natural','80K','90M','80K','1/10','Stable','Grinding'),
V('Spring',['spring'],'Common','Natural','60K','60M','60K','1/10','Stable','Grinding'),
...
V('Meme-Meme',['meme-meme','meme meme','meme fruit limited'],'Limited','Skin','4.5B','—','—','7/10','Stable','Trading','Limited release; tradeable now'),
