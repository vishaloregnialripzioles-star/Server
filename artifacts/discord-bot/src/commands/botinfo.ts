...
export const botinfo:Command={
  ...
  async execute(interaction){
    ...
    const embed=new EmbedBuilder()
      ...
      .setDescription('A clean overview of the bot, its creators, live coverage and runtime.')
      .addFields(
        ...
        {name:'Support Server',value:'[Join the Sparxie Support Server](https://discord.gg/UFvjK5Uy5e)'}
      )
