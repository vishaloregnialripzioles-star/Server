...
function defaultGuildData(): GuildData { return { config: { starboardThreshold:3, snipeEnabled:true, levelRoles:{}, inviteRoles:{}, automod:{ enabled:false, antiSpam:false, antiScam:false, massMentions:false, suspiciousLinks:false, spaceSpam:false, bannedWords:[], antiScamWords:[], action:'delete_timeout', spam:{windowSeconds:5,maxCount:6,action:'delete_timeout'}, mentions:{windowSeconds:5,maxCount:3,action:'delete_timeout'}, space:{windowSeconds:5,maxCount:5,action:'delete_timeout'}, bannedWordsRule:{action:'delete_timeout'}, antiScamRule:{action:'delete_timeout'}, suspiciousLinksRule:{action:'delete_timeout'} }, moderationTemplates:[], logging:{enabled:false,categories:defaultCategories}, giveawayDaily:{enabled:false,message:'🎁 Don’t forget to enter our active giveaway!'} }, antiNuke:{enabled:false,whitelist:[]}, extraOwners:[], afk:{}, levels:{}, sparks:{}, warnings:{}, reminders:[], starboard:{}, lastDeleted:{}, lastEdited:{}, tempRoles:[], tickets:{}, autoResponders:[], giveaways:[], savedEmbeds:{}, shop:{roles:[],colours:[],customRoles:[]}, recoveryBackups:[] }; }
